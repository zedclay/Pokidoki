...
class ApiErrorMapper {
  ...
  String messageKeyForBackendCode(String code) {
    return switch (code) {
      ...
      'PROFILE_NOT_CREATED' => 'profileNotCreated',
      'PROFILE_ALREADY_EXISTS' => 'profileAlreadyExists',
      'PROFILE_NOT_FOUND' => 'profileNotFound',
      'PROFILE_NOT_DISCOVERABLE' => 'profileNotDiscoverable',
      'USERNAME_INVALID' => 'usernameInvalid',
      'USERNAME_UNAVAILABLE' => 'authUsernameUnavailable',
      'USERNAME_CHANGE_TOO_SOON' => 'usernameChangeTooSoon',
      'USER_SEARCH_QUERY_TOO_SHORT' => 'userSearchQueryTooShort',
      ...
      'CONVERSATION_SELF_NOT_ALLOWED' => 'cannotMessageUser',
      ...
      'MESSAGE_NOT_FOUND' => 'messagingUnavailable',
      'MESSAGE_FORBIDDEN' => 'messagingUnavailable',
      'MESSAGE_SEND_NOT_ALLOWED' => 'cannotMessageUser',
      'MESSAGE_CLIENT_ID_INVALID' => 'messageInvalid',
      'MESSAGE_CURSOR_INVALID' => 'messagingUnavailable',
      'MESSAGE_SEARCH_QUERY_TOO_SHORT' => 'messageSearchQueryTooShort',
      'MESSAGE_SEARCH_QUERY_TOO_LONG' => 'messageTooLong',
      'MESSAGE_RECEIPT_FORBIDDEN' => 'messagingUnavailable',
      'WEBSOCKET_UNAUTHORIZED' => 'authSessionExpired',
      'WEBSOCKET_SESSION_EXPIRED' => 'authSessionExpired',
      'WEBSOCKET_RATE_LIMITED' => 'authRateLimited',
